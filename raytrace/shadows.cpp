...
int main(int, char**){
    ...
    */std::vector<Plane*> planes;/*
    ...
    //Sphere s1(Vec3(0,2,-4),2,Colour(.6f,.2f,.6f),Colour(.6f,.2f,.6f),Colour(.6f,.2f,.6f),5);
    Sphere s2(Vec3(0,0,0),1,Colour(.6f,.2f,.6f),Colour(.6f,.2f,.6f),Colour(.6f,.2f,.6f),5);
    //Sphere s3(Vec3(0,0,1),.1,Colour(.6f,.6f,.6f),Colour(.6f,.6f,.6f),Colour(.6f,.6f,.6f),5);
    ...
    LightSource L(Vec3(4,4,0),Colour(.6f,.6f,.6f),Colour(.6f,.6f,.6f),Colour(.6f,.6f,.6f));
